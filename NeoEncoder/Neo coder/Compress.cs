...
public class Compress
{
    ...
    public byte[] InverseTransformBWT(byte[] b)
    {
        ...
        int i;
        for (i = 0; i < bwt.Length; i++) //Сборка смещенных байтов
        {
            offsetBWT[i].Item1 = i;
    ...
    {
        Dictionary<MByte, ushort> dic = new();
